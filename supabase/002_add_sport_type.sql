-- InstaPadel — adds sport_type to courts (Padel / Football / Tennis).
-- Run this in the InstaPadel project's SQL Editor. schema.sql has already been
